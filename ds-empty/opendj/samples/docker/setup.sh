...
create-log-publisher --type console-error --publisher-name "Console Error Logger" --set enabled:true --set json-output:true --set default-severity:error --set default-severity:warning --set default-severity:notice --set override-severity:SYNC=INFO,ERROR,WARNING,NOTICE
